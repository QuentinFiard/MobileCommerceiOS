...
@implementation NSManagedObject (ATGRestAdditions)
...
+ (NSObject *) objectFromDictionary:(NSDictionary *)pDictionary {
  ...
  NSManagedObjectContext *context =
      [self isPersistent] ? [[ATGCacheManagedDocument sharedDocument] managedObjectContext] : nil;
  NSObject *result = [[self alloc] initWithEntity:entityDescription insertIntoManagedObjectContext:context];
...
+ (NSString *) entityDescriptorName {
  // Default implementation, re-define it in subclasses.
