...
/*!
   ...
   @header
   @abstract Core data based cache

   @copyright Copyright </A> &copy; 1994-2013 Oracle and/or its affiliates. All rights reserved.
   @version $Id: //hosting-blueprint/MobileCommerce/version/11.0/clients/iOS/MobileCommerce/ATGMobileCommon/ATGMobileCommon/Cache/ATGCoreDataCache.h#1 $$Change: 848678 $
...
@interface ATGCoreDataCache : NSObject <ATGCache>

@property (nonatomic, strong) NSEntityDescription *entity;
@property (nonatomic, strong) ATGCacheManagedDocument *document;
