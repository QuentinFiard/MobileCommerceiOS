...
@class ATGOrderPriceInfo, ATGContactInfo;

@interface ATGHardgoodShippingGroup : NSObject
...
@property (nonatomic, strong) NSString *shippingGroupClassType;
@property (nonatomic, strong) NSString *shippingMethod;
@property (nonatomic, strong) NSString *locationId;
@property (nonatomic, strong) NSArray *commerceItems;
