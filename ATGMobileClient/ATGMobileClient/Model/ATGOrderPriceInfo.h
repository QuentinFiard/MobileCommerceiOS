...
@interface ATGOrderPriceInfo : NSObject
...
@property (nonatomic, strong) NSDecimalNumber *manualAdjustmentTotal;
@property (nonatomic, strong) NSDecimalNumber *rawSubtotal;
@property (nonatomic, strong) NSString *currencyCode;
@property (nonatomic, strong) NSArray *adjustments;
