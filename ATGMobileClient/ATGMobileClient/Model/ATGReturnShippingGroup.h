...
@interface ATGReturnShippingGroup : NSObject
@property (nonatomic, strong) NSString *shippingGroupId;
@property (nonatomic, strong) NSArray *itemList; // [{commerceItemId}], replaced with [ATGReturnItem] in ATGReturnRequest for workaround
