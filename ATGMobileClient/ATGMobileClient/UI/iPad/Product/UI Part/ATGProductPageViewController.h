...
@class ATGProduct;
@class ATGBaseProductDetailsPage_iPad;

@protocol ATGProductDetailsStackDataSource;

/*!
   @class
   @abstract ATGRenderableProduct details container. Contains product details view, action bar, chevrons for navigation.
 */
@interface ATGProductPageViewController : UIViewController

/*!
   @property innerView
   @abstract Inner view outlet. This view contains product detail view and action bar.
 */
@property (weak, nonatomic) IBOutlet UIView *innerView;

// when displaying the product page from order history, the commerce item is not in the cart
@property(nonatomic) BOOL launchedFromOrderHistory;

// for when we're loading from a commerce item (e.g. click a product in the cart)
