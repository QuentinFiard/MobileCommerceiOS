...
@protocol ATGPickerDelegate <NSObject>
- (void) didSelectValue:(NSString *) pSelected forType:(NSString *) pType;
@end

@protocol ATGPickerViewController
@property (nonatomic, strong) NSString *selectedValue;
@property (nonatomic, strong) id <ATGPickerDelegate> delegate;
@end

@interface ATGPopoverPicker : UIView <ATGPickerDelegate>

@property (nonatomic, strong) UILabel *leftLabel; // Type, what you're selecting, e.g. size, color
