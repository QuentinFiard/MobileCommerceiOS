...
#pragma mark - ATGTableViewController private interface declaration
#pragma mark -

@interface ATGTableViewController ()
...
#pragma mark - ATGTableViewController implementation
#pragma mark -

@implementation ATGTableViewController
...
- (BOOL)isPresentedInPopover {
  return [self.presentingViewController isKindOfClass:[UIPopoverController class]];
}
...
- (void) tableView:(UITableView *)pTableView willDisplayCell:(UITableViewCell *)pCell
 forRowAtIndexPath:(NSIndexPath *)pIndexPath {
  if ([pIndexPath row] < [self errorNumberOfRowsInSection:[pIndexPath section]]) {
    ...
    [pCell setBackgroundColor:[UIColor whiteColor]];
  }
}
