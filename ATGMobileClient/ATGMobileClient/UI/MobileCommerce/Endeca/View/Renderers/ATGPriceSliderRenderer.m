...
@interface ATGPriceSliderRenderer ()

@end

@implementation ATGPriceSliderRenderer
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
      // Initialization code
      self.rangeLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, 300, 14)];
      [[ATGThemeManager themeManager] applyStyle:@"priceSliderRangeLabel" toObject:self.rangeLabel];
      [self.contentView addSubview:self.rangeLabel];
      
      self.rangeSlider = [[ATGRangeSlider alloc] initWithFrame:CGRectMake(10, 21, 300, 28)];
...
- (void)prepareForReuse {
  ...
  [self.rangeSlider removeTarget:nil action:NULL forControlEvents:UIControlEventAllEvents];
}
