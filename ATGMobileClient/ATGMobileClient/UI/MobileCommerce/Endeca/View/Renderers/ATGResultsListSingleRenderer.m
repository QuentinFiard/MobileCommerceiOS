...
@interface ATGResultsListSingleRenderer ()
@end

@implementation ATGResultsListSingleRenderer
...
- (id)initWithFrame:(CGRect)frame
{
  ...
  if (self) {
    ...
    self.carousel = [[ATGCarouselView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, (IS_IPHONE5 ? 424 : 340)) layout:layout pageSize:CGSizeMake(frame.size.width, (IS_IPHONE5 ? 424 : 340)) itemSize:CGSizeMake(260, 260) edgeInsets:UIEdgeInsetsMake(0, 30, 0, 30)];
