...
@interface ATGHorizontalResultsListRenderer : EMContentItemRenderer

@property(nonatomic, strong) ATGCarouselView *carousel;
@property(nonatomic, strong) ATGButton *previousPageButton;
@property(nonatomic, strong) ATGButton *nextPageButton;
