...
@class ATGSearchBox, EMAction, EMSearchBox, EMContentItem;
@protocol ATGSearchBoxDelegate <NSObject>
...
@interface ATGSearchBox : UIView
@property (nonatomic, weak) id<ATGSearchBoxDelegate> delegate;
@property (nonatomic, assign) NSInteger minAutoSuggestInputLength;
@property (nonatomic, strong) EMAction *baseAction;
@property (nonatomic, strong) NSString *searchParam;
