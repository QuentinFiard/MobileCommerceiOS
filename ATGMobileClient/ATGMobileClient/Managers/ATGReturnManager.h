...
@class ATGReturnManagerRequest, ATGReturnRequest;

@interface ATGReturnManager : NSObject
...
- (ATGReturnManagerRequest *)startReturnWithRequest:(ATGReturnRequest *)pReturnRequest success:(void (^)(ATGReturnManagerRequest *, ATGReturnRequest *pReturnRequest))pSuccess failure:(void (^)(ATGReturnManagerRequest *, NSError *))pFailure;

- (ATGReturnManagerRequest *)confirmReturnWithSuccess:(void (^)(ATGReturnManagerRequest *, NSString *))pSuccess failure:(void (^)(ATGReturnManagerRequest *, NSError *))pFailure;

@property (nonatomic, strong) NSDictionary *returnReasons;
@end