...
/*!
 @header
 @abstract EMDataObject class is a base implementation of an assembler class object.
...
/*!
 @class
 @abstract EMDataObject class is a base implementation of an assembler class object.
 @discussion data objects are created by parsing a dictionary with an @class property
 */
@interface EMDataObject : NSObject <NSCopying>
