...
@interface EMAction : EMDataObject

@property(strong, nonatomic) NSString *contentPath;
@property(strong, nonatomic) NSString *siteRootPath;
@property(strong, nonatomic) NSString *state;

/*!
 @method
 @abstract inits EMAction using the supplied path information
 @param pContentPath the content path for this action
 @param pSiteRootPath the site root path
 @param pState the state information
 */
- (id)initWithContentPath:(NSString *)pContentPath siteRootPath:(NSString *)pSiteRootPath state:(NSString *)pState;

/*!
 @method
 @abstract creates and returns an EMAction using the supplied path information
 @param pContentPath the content path for this action
 @param pSiteRootPath the site root path
 @param pState the state information
 */
...
/*!
 @method
 @abstract creates and returns an EMAction using the supplied search term and path information
 @param pSearchTerm the search term for this action
 @param pContentPath the content path for this action
 @param pSiteRootPath the site root path
 @param pState the state information
 */
...
/*!
 @method
 @abstract creates and returns an EMAction using the supplied range min,max, property and path information
 @param pMin the range min
 @param pMax the range max
 @param pProperty the range property
 @param pContentPath the content path for this action
 @param pSiteRootPath the site root path
 @param pState the state information
 */
