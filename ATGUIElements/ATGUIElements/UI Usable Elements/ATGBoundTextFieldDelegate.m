...
@implementation ATGBoundTextFieldDelegate {

}

- (BOOL)textFieldShouldBeginEditing:(ATGBoundTextField *)textField {
...
- (void)textFieldDidBeginEditing:(ATGBoundTextField *)textField {
  NSString *boundPropertyValue = [textField getBoundPropertyValue];
  textField.text = (boundPropertyValue && textField.initializeWithBoundValue ? boundPropertyValue : @"");
...
- (BOOL)textFieldShouldEndEditing:(ATGBoundTextField *)textField {
...
- (void)textFieldDidEndEditing:(ATGBoundTextField *)textField {
  NSString *valueToBind = textField.text;
  if (valueToBind) {
    [textField setBoundPropertyValue:valueToBind];
  }
...
- (BOOL)textField:(ATGBoundTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
...
- (BOOL)textFieldShouldClear:(ATGBoundTextField *)textField {
...
- (BOOL)textFieldShouldReturn:(ATGBoundTextField *)textField {
