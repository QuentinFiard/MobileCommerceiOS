...
@implementation EMAssemblerConnectionURLBuilder
...
- (NSString *)constructRelativePathWithContentPath:(NSString *)pContentPath siteRootPath:(NSString *)pSiteRootPath actionPath:(NSString *)pActionPath {
  NSString *path = [NSString stringWithFormat:@"%@%@%@", (pSiteRootPath ? pSiteRootPath : @""), [NSString prependString:pContentPath withPrefix:@"/"], [NSString prependString:pActionPath withPrefix:@"/"]];
...
- (NSString *)constructBaseURLWithProtocol:(NSString *)pProtocol host:(NSString *) pHost port:(NSInteger) pPort contextPath:(NSString *) pContextPath formatString:(NSString *) pFormatString {
  return [NSString stringWithFormat:@"%@%@:%i%@%@/", pProtocol, pHost, pPort, [NSString prependString:pContextPath withPrefix:@"/"], [NSString prependString:pFormatString withPrefix:@"/"]];
}
