...
#import "ATGSimpleProductGridCollectionViewCell_iPhone.h"
#import <ATGMobileClient/ATGRestManager.h>
#import <ATGUIElements/ATGImageView.h>
#import <ATGMobileClient/ATGBaseProduct.h>

#pragma mark - ATGSimpleProductGridCollectionViewCell_iPhone Private Protocol Definition
#pragma mark -

@interface ATGSimpleProductGridCollectionViewCell_iPhone ()
...
#pragma mark - ATGSimpleProductGridCollectionViewCell_iPhone Implementation
#pragma mark -

@implementation ATGSimpleProductGridCollectionViewCell_iPhone
...
- (void)setObjectToDisplay:(id)pObjectToDisplay {
  ...
  if ([pObjectToDisplay isKindOfClass:[ATGBaseProduct class]]) {
    ATGBaseProduct *product = (ATGBaseProduct *)pObjectToDisplay;
    self.isAccessibilityElement = YES;
    NSMutableString *string = [[NSMutableString alloc] initWithString:product.displayName];
    self.accessibilityLabel = string;
    self.accessibilityHint = NSLocalizedStringWithDefaultValue(@"ATGSimpleProductGridCollectionViewCell_iPhone.Acceccibility.Hint", nil, [NSBundle mainBundle], @"double tap for more details", @"Cell hint, double tap to see more details");
