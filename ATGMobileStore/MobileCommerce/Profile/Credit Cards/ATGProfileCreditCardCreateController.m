...
#import "ATGProfileCreditCardCreateController.h"
#import <ATGMobileClient/ATGCardTypeViewController.h>
...
#import <ATGMobileClient/ATGCCValidator.h>
...
#pragma mark - ATGProfileCreditCardCreateController Private Protocol
#pragma mark -

@interface ATGProfileCreditCardCreateController () <ATGCardTypeViewControllerDelegate, ATGDatePickerDelegate,
                                                    UITextFieldDelegate, ATGKeyboardToolbarDelegate, UIPickerViewDelegate,
                                                    UIPickerViewDataSource>

#pragma mark IB Outlets

@property (nonatomic, readwrite, weak) IBOutlet UILabel *nicknameLabel;
@property (nonatomic, readwrite, weak) IBOutlet UILabel *cardNumberLabel;
@property (nonatomic, readwrite, weak) IBOutlet UILabel *expirationDateLabel;
@property (nonatomic, readwrite, weak) IBOutlet ATGValidatableInput *nicknameInput;
@property (nonatomic, readwrite, weak) IBOutlet ATGValidatableInput *cardNumberInput;
@property (nonatomic, readwrite, weak) IBOutlet UITextField *expirationDateInput;
@property (nonatomic, readwrite, weak) IBOutlet UITableViewCell *cardTypeCell;
@property (nonatomic, readwrite, weak) IBOutlet ATGValidatableDropdown *cardTypeInput;
@property (nonatomic, readwrite, weak) IBOutlet UIBarButtonItem *continueItem;
@property (nonatomic, readwrite, weak) IBOutlet UIButton *continueButton;
@property (nonatomic, readwrite, weak) IBOutlet UILabel *cardTypeLabel;
...
#pragma mark - ATGProfileCreditCardCreateController Implementation
#pragma mark -

@implementation ATGProfileCreditCardCreateController
...
@synthesize nicknameInput;
@synthesize nicknameLabel;
@synthesize cardNumberInput;
@synthesize cardNumberLabel;
@synthesize expirationDateInput;
@synthesize expirationDateLabel;
@synthesize cardTypeCell;
@synthesize cardValidator;
@synthesize cardTypeInput;
@synthesize continueItem;
...
- (void) viewDidLoad {
  ...
  title = NSLocalizedStringWithDefaultValue
            ...
            @"Label for the credit card expiration date input field.");
...
- (CGSize) contentSizeForViewInPopover {
  ...
  return CGSizeMake(320, rowsHeight + footerHeight + 20);
}
...
- (NSInteger) tableView:(UITableView *)pTableView numberOfRowsInSection:(NSInteger)pSection {
  ...
  return (IS_IPAD ? 0 : 1); //On iPad do not use a done cell, in favor of the toolbar. Do not return a cell since done cell doesnt exist
}
...
#pragma mark - ATGCardTypeViewControllerDelegate
...
- (void) didSubmitContinue {
  [self setRequest:[[ATGExternalProfileManager profileManager] validateNewCreditCard:[self creditCard]
                                                                        save:YES
                                                                useAsDefault:NO
                                                                    delegate:self]];
}
