...
#import "ATGProfileBillingAddressEditController.h"
#import "ATGProfileBillingAddressSection.h"
#import <ATGMobileClient/ATGContactInfo.h>

#pragma mark - ATGProfileBillingAddressEditController Private Protocol
#pragma mark -

@interface ATGProfileBillingAddressEditController ()

// No @synthesize for these properties, as we're emulating protected properties.
@property (nonatomic, readwrite, assign) BOOL creating;
@property (nonatomic, readwrite, strong) ATGAddressSection *addressSection;

@end

#pragma mark - ATGProfileBillingAddressEditController Implementation
#pragma mark -

@implementation ATGProfileBillingAddressEditController

- (void)createAddressSection {
  [self setAddressSection:[[ATGProfileBillingAddressSection alloc] init]];
