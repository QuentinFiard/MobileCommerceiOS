...
#import "ATGCheckoutBillingAddressEditController.h"
#import "ATGCheckoutBillingAddressSection.h"
#import "ATGCVVViewController.h"

static NSString *const ATGEditBillingAddressToCVVSegue = @"checkoutBillingAddressEditToCVV";

#pragma mark - ATGCheckoutBillingAddressEditController Private Protocol
#pragma mark -

@interface ATGCheckoutBillingAddressEditController ()
...
#pragma mark - ATGCheckoutBillingAddressEditController Implementation
#pragma mark -

@implementation ATGCheckoutBillingAddressEditController

- (void) createAddressSection {
  [self setAddressSection:[[ATGCheckoutBillingAddressSection alloc] init]];
  ...
  [self addressSection].showsNickname = ![self creating];
...
- (void) prepareForSegue:(UIStoryboardSegue *)pSegue sender:(id)pSender {
  if ([pSegue.identifier isEqualToString:ATGEditBillingAddressToCVVSegue]) {
    ATGCVVViewController *ctrl = pSegue.destinationViewController;
    ctrl.card = self.creditCard;
    ctrl.type = ValidateFromCreateAddr;
  } else {
