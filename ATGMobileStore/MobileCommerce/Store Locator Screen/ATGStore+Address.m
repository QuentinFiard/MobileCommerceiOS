...
#pragma mark - ATGStore (Address) category implementation
#pragma mark -

@implementation ATGStore (Address)

- (NSString *) address {
  // Use the US postal address format. This will produce two lines of address.
  NSMutableString *result = [NSMutableString stringWithString:[self address1]];
