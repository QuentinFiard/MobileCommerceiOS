...
/*!
   @class ATGSignupTableViewCell_iPad
   @abstract Represents a 'Sign Up' cell on the 'Login' screen in iPad app.
 */
@interface ATGSignupTableViewCell_iPad : UITableViewCell <ATGExpandableTableViewCell>
/*!
   @property delegate
...
/*!
 @property email
 @abstract Assign a value to this property to prefill email input field on the signup form.
 */
@property (nonatomic, readwrite, copy) NSString *email;
/*!
   @method setError:
   @abstract Set error string for cell.
